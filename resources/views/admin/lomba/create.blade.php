                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            ...
                            <x-text-input id="hadiah" name="hadiah" type="text" class="mt-1 block w-full" :value="old('hadiah')" placeholder="Contoh: Total Rp 50.000.000" />
                        ...
                        <div class="col-span-2">
                            ...
                            <x-text-input id="link_resmi" name="link_resmi" type="url" class="mt-1 block w-full" :value="old('link_resmi')" required placeholder="https://..." />
                        ...
                        <div class="col-span-2">
                            ...
                            <p class="mt-1 text-xs text-gray-500">Maksimal 2MB (Image format)</p>
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea id="syarat_peserta" name="syarat_peserta" rows="3" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('syarat_peserta') }}</textarea>
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="5" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('deskripsi') }}</textarea>
